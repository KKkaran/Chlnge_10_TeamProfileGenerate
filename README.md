<h1 align='center'>Team Profile Generator<span><img src="icons/project.png" height="25" width="25"/></span></h1>
    ...
    <p><img src="icons/search.png" height="18" width="20"/>In this app, we get user's input for the team members using inquirer and then write the index.html file that will be displayed in the browser.</p>
    <hr>
    ...
    <hr>
    <h2 id="test">Tests</h2>
    <p><img src="icons/pencil.png" height="18" width="20"/>Unit Testing using jest</p>
    <hr>
